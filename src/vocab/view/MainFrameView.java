...
import static vocab.view.ForeignLanguage.Hokkien;
import static vocab.view.ForeignLanguage.Japanese;
import static vocab.view.ForeignLanguage.Mandarin;
...
public final class MainFrameView extends javax.swing.JFrame
{
    ...
    private static String selectedForeignLanguage;
    ...
    {   
        ...
        setForeignLanguage(ForeignLanguage.Hokkien.toString());

        this.cardLayout = new CardLayout();
        this.setIconImage(new ImageIcon(getClass().getResource("/vocab/images/icon.png")).getImage());

        this.mainPanel.setLayout(this.cardLayout); 
        this.mainPanel.add(this.add, "Add");
        this.mainPanel.add(this.view, "View");
    ...
    private void initComponents() {
        ...
        try
        {
            URL url = MainFrameView.class.getResource("/vocab/images/search_icon.png");
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vocab/images/background.png"))); // NOI18N
